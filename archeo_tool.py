...
class ArcheoTool:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ArcheoTool', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ArcheoTool/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'ArcheoTool'),
            callback=self.run,
